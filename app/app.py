...
def chat_app():
    ...
    with container:
        ...
        with col2:
            ...
            st.write(
                "InternationAlly is an AI-powered platform designed to assist international students in their journey abroad. "
                "Meet Ally, your personalized AI companion. Ally is here to help with finding an apartment, providing local insights, or offering guidance on logistical matters like Social Security Numbers and health insurance."
            )
